...
/**
 * The interface for the coordinate local service.
 *
 * <p>
...
public interface CoordinateLocalService extends BaseLocalService,
	 ...
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this interface directly. Always use {@link CoordinateLocalServiceUtil} to access the coordinate local service. Add custom service methods to {@link edu.jhu.cvrg.waveform.main.dbpersistence.service.impl.CoordinateLocalServiceImpl} and rerun ServiceBuilder to automatically copy the method declarations to this interface.
	 */
	...
	*/
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public java.util.List<edu.jhu.cvrg.waveform.main.dbpersistence.model.Coordinate> getCoordinates(
		int start, int end)
		throws com.liferay.portal.kernel.exception.SystemException;
