 ...
 * @author bbenite1
 */
public class DocumentRecordLocalServiceClp implements DocumentRecordLocalService {
	public DocumentRecordLocalServiceClp(
		...
		_methodName19 = "addDocumentRecord";
	...
	public edu.jhu.cvrg.waveform.main.dbpersistence.model.DocumentRecord addDocumentRecord(
		...
		try {
			returnObj = _invokableLocalService.invokeMethod(_methodName0,
					...
					new Object[] { ClpSerializer.translateInput(documentRecord) });
		}
		catch (Throwable t) {
	...
	public edu.jhu.cvrg.waveform.main.dbpersistence.model.DocumentRecord updateDocumentRecord(
		...
		try {
			returnObj = _invokableLocalService.invokeMethod(_methodName15,
					...
					new Object[] {
						ClpSerializer.translateInput(documentRecord),
