 ...
 * @author bbenite1
 */
public class FilesInfoLocalServiceClp implements FilesInfoLocalService {
	public FilesInfoLocalServiceClp(InvokableLocalService invokableLocalService) {
	...
	public edu.jhu.cvrg.waveform.main.dbpersistence.model.FilesInfo addFilesInfo(
		...
		try {
			returnObj = _invokableLocalService.invokeMethod(_methodName0,
					...
					new Object[] { ClpSerializer.translateInput(filesInfo) });
		}
		catch (Throwable t) {
	...
	public edu.jhu.cvrg.waveform.main.dbpersistence.model.FilesInfo updateFilesInfo(
		...
		try {
			returnObj = _invokableLocalService.invokeMethod(_methodName15,
					...
					new Object[] { ClpSerializer.translateInput(filesInfo), merge });
		}
		catch (Throwable t) {
			t = ClpSerializer.translateThrowable(t);
