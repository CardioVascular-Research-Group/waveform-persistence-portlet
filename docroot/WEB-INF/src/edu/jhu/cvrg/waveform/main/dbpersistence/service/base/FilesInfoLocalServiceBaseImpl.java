...
/**
 * The base implementation of the files info local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link edu.jhu.cvrg.waveform.main.dbpersistence.service.impl.FilesInfoLocalServiceImpl}.
 * </p>
 *
 * @author bbenite1
 ...
 * @generated
 */
public abstract class FilesInfoLocalServiceBaseImpl extends BaseLocalServiceImpl
	implements FilesInfoLocalService, IdentifiableBean {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Always use {@link edu.jhu.cvrg.waveform.main.dbpersistence.service.FilesInfoLocalServiceUtil} to access the files info local service.
	 */
	...
	public FilesInfo addFilesInfo(FilesInfo filesInfo)
		throws SystemException {
		filesInfo.setNew(true);

		return filesInfoPersistence.update(filesInfo, false);
	}
	 ...
	 */
	@Indexable(type = IndexableType.DELETE)
	public FilesInfo deleteFilesInfo(FilesInfo filesInfo)
		throws SystemException {
		return filesInfoPersistence.remove(filesInfo);
	}

	public DynamicQuery dynamicQuery() {
		Class<?> clazz = getClass();

		return DynamicQueryFactoryUtil.forClass(FilesInfo.class,
	...
	public List dynamicQuery(DynamicQuery dynamicQuery)
		throws SystemException {
		return filesInfoPersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public List dynamicQuery(DynamicQuery dynamicQuery, int start, int end)
		throws SystemException {
		return filesInfoPersistence.findWithDynamicQuery(dynamicQuery, start,
			end);
	}
	...
	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		throws PortalException, SystemException {
		return filesInfoPersistence.findByPrimaryKey(primaryKeyObj);
	}
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public List<FilesInfo> getFilesInfos(int start, int end)
		throws SystemException {
		return filesInfoPersistence.findAll(start, end);
	}
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public int getFilesInfosCount() throws SystemException {
		return filesInfoPersistence.countAll();
	}
	 ...
	 */
	@Indexable(type = IndexableType.REINDEX)
	public FilesInfo updateFilesInfo(FilesInfo filesInfo)
		throws SystemException {
		return updateFilesInfo(filesInfo, true);
	}
	 ...
	 */
	@Indexable(type = IndexableType.REINDEX)
	public FilesInfo updateFilesInfo(FilesInfo filesInfo, boolean merge)
		throws SystemException {
		filesInfo.setNew(false);

		return filesInfoPersistence.update(filesInfo, merge);
	}
	...
	public void afterPropertiesSet() {
		PersistedModelLocalServiceRegistryUtil.register("edu.jhu.cvrg.waveform.main.dbpersistence.model.FilesInfo",
			filesInfoLocalService);
	}
	...
	protected void runSQL(String sql) throws SystemException {
		try {
			DataSource dataSource = filesInfoPersistence.getDataSource();
	...
	private FilesInfoLocalServiceClpInvoker _clpInvoker = new FilesInfoLocalServiceClpInvoker();
}