...
/**
 * The base implementation of the coordinate local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link edu.jhu.cvrg.waveform.main.dbpersistence.service.impl.CoordinateLocalServiceImpl}.
 * </p>
 *
 * @author bbenite1
...
public abstract class CoordinateLocalServiceBaseImpl
	 ...
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Always use {@link edu.jhu.cvrg.waveform.main.dbpersistence.service.CoordinateLocalServiceUtil} to access the coordinate local service.
	 */
	...
	public Coordinate addCoordinate(Coordinate coordinate)
		...
		return coordinatePersistence.update(coordinate, false);
	}
	...
	public Coordinate updateCoordinate(Coordinate coordinate)
		throws SystemException {
		return updateCoordinate(coordinate, true);
	}
	 ...
	 */
	@Indexable(type = IndexableType.REINDEX)
	public Coordinate updateCoordinate(Coordinate coordinate, boolean merge)
		throws SystemException {
		coordinate.setNew(false);

		return coordinatePersistence.update(coordinate, merge);
	}
	...
	public void afterPropertiesSet() {
		PersistedModelLocalServiceRegistryUtil.register("edu.jhu.cvrg.waveform.main.dbpersistence.model.Coordinate",
