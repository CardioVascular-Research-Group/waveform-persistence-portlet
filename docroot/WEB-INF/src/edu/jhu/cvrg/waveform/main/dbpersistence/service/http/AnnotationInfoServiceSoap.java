 ...
 * {@link edu.jhu.cvrg.waveform.main.dbpersistence.service.AnnotationInfoServiceUtil} service utility. The
 ...
 * is translated to an array of {@link edu.jhu.cvrg.waveform.main.dbpersistence.model.AnnotationInfoSoap}.
 * If the method in the service utility returns a
 * {@link edu.jhu.cvrg.waveform.main.dbpersistence.model.AnnotationInfo}, that is translated to a
 * {@link edu.jhu.cvrg.waveform.main.dbpersistence.model.AnnotationInfoSoap}. Methods that SOAP cannot
 ...
 *
 * @author    bbenite1
 * @see       AnnotationInfoServiceHttp
 * @see       edu.jhu.cvrg.waveform.main.dbpersistence.model.AnnotationInfoSoap
...
public class AnnotationInfoServiceSoap {
		...
		try {
			edu.jhu.cvrg.waveform.main.dbpersistence.model.AnnotationInfo returnValue =
				AnnotationInfoServiceUtil.addAnnotationInfo(liferayUserId,
					...
					annotationType, name, bioportalRef, lead, startCoord,
					endCoord, unitMeasurement, description, value, timestamp);

			return edu.jhu.cvrg.waveform.main.dbpersistence.model.AnnotationInfoSoap.toSoapModel(returnValue);
		}
		catch (Exception e) {
			_log.error(e, e);
	...
	public static edu.jhu.cvrg.waveform.main.dbpersistence.model.AnnotationInfoSoap deleteAnnotationInfo(
		java.lang.String annotationID) throws RemoteException {
		try {
			edu.jhu.cvrg.waveform.main.dbpersistence.model.AnnotationInfo returnValue =
				AnnotationInfoServiceUtil.deleteAnnotationInfo(annotationID);
	...
	public static edu.jhu.cvrg.waveform.main.dbpersistence.model.AnnotationInfoSoap[] getAnnotationsByRecord(
		...
		try {
			...
			return edu.jhu.cvrg.waveform.main.dbpersistence.model.AnnotationInfoSoap.toSoapModels(returnValue);
		}
		catch (Exception e) {
			_log.error(e, e);
	...
	private static Log _log = LogFactoryUtil.getLog(AnnotationInfoServiceSoap.class);
}